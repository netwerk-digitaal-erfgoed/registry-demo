    ...
    <body>
        ...
        <div class="container px-3 pt-3 pt-md-5 pb-md-4 mx-auto">
			...
			<div class="content">
				...
				<p>Het doel van het Datasetregister is om inzicht te krijgen in erfgoeddatasets. Erfgoedinstellingen worden aangemoedigd om datasets aan te bieden vanuit hun systeem, deze datasets te beschrijven en online te publiceren en om deze URL's van datasetbeschrijvingen aan te melden bij het Datasetregister. Het Datasetregister haalt de datasetbeschrijvingen op waardoor de erfgoeddatasets doorzoekbaar gemaakt kan worden.</p>
				...
				<p>In de toekomst gaat het Datasetregister ook datacatalogs ondersteunen. Deze set van datasets geeft in één keer informatie over alle beschikbare datasets van een organisatie.</p>
				...
				<h3 class="display-5"><a id="allowed_domain_names"></a>Kan iedereen een datasetbeschrijving toevoegen aan het Datasetregister?</h3>
