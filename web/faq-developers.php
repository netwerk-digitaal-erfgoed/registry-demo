...
<main>
   <div class="o-container o-container__small m-t-space">
      ...
      <p><?= t('De tweede API is gericht op ontwikkelaars die datasets willen vinden: het <strong>SPARQL-endpoint</strong> <a href="https://triplestore.netwerkdigitaalerfgoed.nl/repositories/registry">https://triplestore.netwerkdigitaalerfgoed.nl/repositories/registry</a>.')?></p>
      ...
      <p><?= t('Een andere manier om gevoel te krijgen bij de mogelijkheden is de <a href="https://datastories.demo.netwerkdigitaalerfgoed.nl/hackalod/datasetregister/">Data Stories</a>. Alleen nog beschikbaar in het Nederlands, maar via de blauwwe pijl boven de resultaat tabellen tover je de SPARQL-query naar voren waarmee de gegevens voor tabel eronder zijn verkregen. Pas de query aan en je ziet gelijk het resultaat!')?></p>
