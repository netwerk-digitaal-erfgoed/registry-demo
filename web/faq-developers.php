...
<main>
   <div class="o-container o-container__small m-t-space">
      ...
      <p><?= t('Het Datasetregister bevat geen datasets, wel bevat het datasetbeschrijvingen en deze bevatten referentie naar (distributies van) data. Dit kunnen bestanden/datadumps zijn (bijvoorbeeld gecomprimeerde XML, CSV, NT bestanden) of API\'s (bijvoorbeeld OAI-PMH, SPARQL, SRU). Wanneer een datasetbeschrijving bij de bron wordt opgehaald en gecontroleered, dan wordt deze in een eigen graaf opgeslagen op basis van <code>dcat:Dataset</code>. De URL van de graaf correspondeert met de IRI van de dataset. Datasetbeschrijvingen die worden geleverd op basis van schema.org - zoals geadviseerd in de <a href="https://docs.nde.nl/requirements-datasets/">Requirements for Datasets</a> - worden geconverteerd naar <a href="https://www.w3.org/TR/vocab-dcat-2/">DCAT</a>. Meer informatie hierover op de <a href="datamodel.php">datamodel-pagina</a>.')?></p>
