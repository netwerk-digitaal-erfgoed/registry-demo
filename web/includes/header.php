...
<html class="no-js ie ie9" lang="nl-NL">
   ...
   <html class="no-js" lang="nl-NL">
      ...
      <head>
         ...
         <link rel="stylesheet" id="nde-style-css" href="assets/style.20211111.css" type="text/css" media="all">
         <link rel="stylesheet" id="site-style-css" href="assets/site.20211111.css" type="text/css" media="all">
            ...
            <div class="o-container">
               <nav class="desktop">
                  <div class="menu-holder">
                     <a href="/" class="logo m-select--none" aria-label="Naar de startpagina van het Datasetregister" aria-labelledby="header" style="width:400px;margin-top:12px">
