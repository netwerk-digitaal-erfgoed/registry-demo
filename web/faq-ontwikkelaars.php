...
<main>
   <section class="text m-t-space m-b-space m-theme--blue">
      <div class="o-container o-container__small m-t-space">
         <h1><?= t('Veelgestelde vragen voor ontwikkelaars van erfgoedsoftware') ?></h1>
         <p><br></p>
         ...
         <p><?= t('De informatie die verplicht en aanbevolen is - op basis van <a href="https://schema.org/Dataset">schema.org/Dataset</a> - staat beschreven in een <a href="https://docs.nde.nl/requirements-datasets/">requirements document</a>.') ?></p>
         ...
         <li><?= t('als &lt;script type="application/ld+json"&gt; blok met <a href="https://json-ld.org/">JSON-LD</a> in een HTML pagina (aan serverkant ingevoegd of via Javascript aan client-zijde geïnjecteerd);') ?></li>
         ...
         <p><?= t('Het aanmelden van datasets via de REST API werkt op basis van een <a href="https://qlever.netwerkdigitaalerfgoed.nl/datasetregister/CYjX1Y?exec=true" target="_blank">lijst van toegestane domeinen</a>. Datasetbechrijvingen (en datacatalogi) die afkomstig zijn van domeinen op deze lijst worden toegevoegd.') ?></p>
         ...
         <p><?= t('Via de REST API kan de datasetbeschrijving van een datasetbeschrijving worden gecontroleerd op de <a href="https://docs.nde.nl/requirements-datasets/">Requirements for Datasets</a>.') ?></p>
