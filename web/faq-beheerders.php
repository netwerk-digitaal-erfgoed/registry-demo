...
<main>
   <div class="o-container o-container__small m-t-space">
      <h1>Veelgestelde vragen over het Datasetregister door dataset beheerders bij erfgoedinstellingen</h1>
      <p><br></p>
      <h3>Wat is een dataset?</h3>
      ...
      <h3>Welke informatie bevat een datasetbeschrijving?</h3>
      ...
      <h3>Waar wordt een datasetbeschrijving gepubliceerd?</h3>
	  ...
	  <p>Als het publiceren niet via de eigen infrastructuur zoals CMS lukt, dan kan er gebruik worden gemaakt van de "publication service" <a href="https://github.com/netwerk-digitaal-erfgoed/dataset-register-entries">Dataset Register entries</a> via Github.</p>
      <h3>Hoe kan ik mijn datasetbeschrijving controleren?</h3>
      ...
      <h3>Wat is het Datasetregister?</h3>
      ...
      <h3>Hoe kan ik een datasetbeschrijving aanmelden bij het Datasetregister?</h3>
      ...
      <h3>Hoe kan ik het Datasetregister uitproberen?</h3>
      ...
      <h3>Wie maakt en beheert het Datasetregister?</h3>
      ...
      <h3>Wat is de status van het Datasetregister?</h3>
      ...
      <h3>Kan ik al aan de slag met datasetbeschrijvingen maken?</h3>
