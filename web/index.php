    ...
    <body>
        ...
        <div class="container px-3 pt-3 pt-md-5 pb-md-4 mx-auto">
            <div class="text-center">
                ...
                <p><br/></p>
                <p>
                    <a class="btn btn-primary" href="form.php">Datasetbeschrijving maken (handmatig via formulier)</a><br/>
                    <br/>
                    ...
                    <br/>
                    <a class="btn btn-primary" href="list.php">Overzicht van datasetbeschrijvingen</a>
                </p>
            </div>
        </div>
